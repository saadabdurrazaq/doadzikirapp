...
public class DoaSore extends AppCompatActivity {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Dzikir Sore");
                    isShow = true;
                } else if(isShow) {
    ...
    private List<ModelDoa> getData() {
        ...
        String[] latin = getResources().getStringArray(R.array.latinsore);
        String[] arti = getResources().getStringArray(R.array.artisore);
        String[] sumber = getResources().getStringArray(R.array.sumbersore);
        String[] baca = getResources().getStringArray(R.array.bacasore);
