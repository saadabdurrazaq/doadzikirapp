...
public class DoaPakaian extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa_pakaian);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Doa Memakai & Melepas Pakaian");
                    isShow = true;
                } else if(isShow) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DoaPakaian.this);
    ...
    private List<ModelDoa> getData() {
        ...
        String[] data = getResources().getStringArray(R.array.doapakaian);
        String[] latin = getResources().getStringArray(R.array.latinpakaian);
        String[] arti = getResources().getStringArray(R.array.artipakaian);
        String[] sumber = getResources().getStringArray(R.array.sumberpakaian);
        String[] baca = getResources().getStringArray(R.array.bacapakaian);
