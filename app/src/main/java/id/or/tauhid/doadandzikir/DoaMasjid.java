...
public class DoaMasjid extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa_masjid);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Doa Masuk & Keluar Masjid");
                    isShow = true;
                } else if(isShow) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DoaMasjid.this);
    ...
    private List<ModelDoa> getData() {
        ...
        String[] data = getResources().getStringArray(R.array.doamasjid);
        String[] latin = getResources().getStringArray(R.array.latinmasjid);
        String[] arti = getResources().getStringArray(R.array.artimasjid);
        String[] sumber = getResources().getStringArray(R.array.sumbermasjid);
        String[] baca = getResources().getStringArray(R.array.bacamasjid);
