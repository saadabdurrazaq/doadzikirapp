...
public class YukulViewHolder extends RecyclerView.ViewHolder {
    ...
    public YukulViewHolder(View view) {
        super(view);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ( 0 == getAdapterPosition() ) {
                    ...
                    Intent myIntent = new Intent(view.getContext(), DoaSebelumMakan.class);
                    view.getContext().startActivity(myIntent);

                }
                else if ( 1 == getAdapterPosition() )
                {
                    Intent myIntent = new Intent(view.getContext(), DoaSetelahMakan.class);
                    view.getContext().startActivity(myIntent);
                }
            }
        });
