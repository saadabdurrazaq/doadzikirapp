...
public class ChildTidur extends AppCompatActivity implements TidurAdapter.ContactsAdapterListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tidurModelList = new ArrayList<>();
        mAdapter = new TidurAdapter(this, tidurModelList, this);
        ...
        protected void onPostExecute(String result) {
            ...
            JsonArrayRequest request = new JsonArrayRequest(URL, new Response.Listener<JSONArray>() {
                ...
                public void onResponse(JSONArray response) {
                    pdLoading.dismiss();
                    List<TidurModel> items = new Gson().fromJson(response.toString(), new TypeToken<List<TidurModel>>() {
                    }.getType());

                    // adding contacts to contacts list
                    tidurModelList.clear();
                    tidurModelList.addAll(items);
    ...
    @Override
    public void onContactSelected(TidurModel tidurModel) {
        Toast.makeText(getApplicationContext(), "Selected: " + tidurModel.getName(), Toast.LENGTH_LONG).show();
    }
}
