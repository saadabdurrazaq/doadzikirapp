...
public class DoaSetelahMakan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa_setelahmakan);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Doa Setelah Makan");
                    isShow = true;
                } else if(isShow) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DoaSetelahMakan.this);
    ...
    private List<ModelDoa> getData() {
        ...
        String[] data = getResources().getStringArray(R.array.doasetelahmakan);
        String[] latin = getResources().getStringArray(R.array.latinsetelahmakan);
        String[] arti = getResources().getStringArray(R.array.artisetelahmakan);
        String[] sumber = getResources().getStringArray(R.array.sumbersetelahmakan);
        String[] baca = getResources().getStringArray(R.array.bacasetelahmakan);
