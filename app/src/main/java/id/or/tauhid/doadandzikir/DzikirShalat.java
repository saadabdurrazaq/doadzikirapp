...
public class DzikirShalat extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Dzikir Setelah Shalat");
                    isShow = true;
                } else if(isShow) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DzikirShalat.this);
    ...
    private List<ModelDoa> getData() {
        ...
        String[] data = getResources().getStringArray(R.array.dzikirshalat);
        String[] latin = getResources().getStringArray(R.array.latindzikir);
        String[] arti = getResources().getStringArray(R.array.artidzikir);
        String[] sumber = getResources().getStringArray(R.array.sumberdzikir);
        String[] baca = getResources().getStringArray(R.array.bacadzikir);
