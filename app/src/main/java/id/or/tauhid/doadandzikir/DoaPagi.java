...
//INI MELIBATKAN AdapterDoa, DoaViewHolder, ModelDoa, activity_doa_pagi, content_doa
...
public class DoaPagi extends AppCompatActivity {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Dzikir Pagi");
                    isShow = true;
                } else if(isShow) {
    ...
    private List<ModelDoa> getData() {
        ...
        String[] latin = getResources().getStringArray(R.array.latinpagi);
        String[] arti = getResources().getStringArray(R.array.artipagi);
        String[] sumber = getResources().getStringArray(R.array.sumberpagi);
