...
public class DoaJimak extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa_jimak);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Doa Sebelum Bersetubuh");
                    isShow = true;
                } else if(isShow) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DoaJimak.this);
    ...
    private List<ModelDoa> getData() {
        ...
        String[] data = getResources().getStringArray(R.array.doajimak);
        String[] latin = getResources().getStringArray(R.array.latinjimak);
        String[] arti = getResources().getStringArray(R.array.artijimak);
        String[] sumber = getResources().getStringArray(R.array.sumberjimak);
        String[] baca = getResources().getStringArray(R.array.bacajimak);
