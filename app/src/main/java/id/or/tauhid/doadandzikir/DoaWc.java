...
public class DoaWc extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa_wc);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Doa Masuk & Keluar WC");
                    isShow = true;
                } else if(isShow) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DoaWc.this);
    ...
    private List<ModelDoa> getData() {
        ...
        String[] data = getResources().getStringArray(R.array.doawc);
        String[] latin = getResources().getStringArray(R.array.latinwc);
        String[] arti = getResources().getStringArray(R.array.artiwc);
        String[] sumber = getResources().getStringArray(R.array.sumberwc);
        String[] baca = getResources().getStringArray(R.array.bacawc);
