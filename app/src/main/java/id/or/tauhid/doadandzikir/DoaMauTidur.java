...
public class DoaMauTidur extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa_mau_tidur);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Doa Menjelang Tidur");
                    isShow = true;
                } else if(isShow) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DoaMauTidur.this);
    ...
    private List<ModelDoa> getData() {
        ...
        String[] data = getResources().getStringArray(R.array.mautidur);
        String[] latin = getResources().getStringArray(R.array.latinmauti);
        String[] arti = getResources().getStringArray(R.array.artimauti);
        String[] sumber = getResources().getStringArray(R.array.sumbermauti);
        String[] baca = getResources().getStringArray(R.array.bacamauti);
