...
public class DoaBangunt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_doa_bangunt);
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbarLayout.setTitle("Doa Bangun Tidur");
                    isShow = true;
                } else if(isShow) {
        ...
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(DoaBangunt.this);
    ...
    private List<ModelDoa> getData() {
        ...
        String[] data = getResources().getStringArray(R.array.banguntidur);
        String[] latin = getResources().getStringArray(R.array.latinbt);
        String[] arti = getResources().getStringArray(R.array.artibt);
        String[] sumber = getResources().getStringArray(R.array.sumberbt);
        String[] baca = getResources().getStringArray(R.array.bacabangun);
